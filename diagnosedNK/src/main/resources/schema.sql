...
(
    ...
    CONSTRAINT pk_calculatedElementElement PRIMARY KEY (id),
    CONSTRAINT FK_CALCULATED_ELEMENTS_ON_VISUAL_MEASURING_SURVEYS
...
(
    ...
    CONSTRAINT FK_CALCULATED_PARTS_ELEMENTS_ON_VISUAL_MEASURING_SURVEYS
        FOREIGN KEY (visual_measuring_survey_id) REFERENCES visual_measuring_surveys (id)
);
...
(
    ...
    CONSTRAINT FK_CALCULATED_DEFECTS_ON_VISUAL_MEASURING_SURVEYS
        FOREIGN KEY (visual_measuring_survey_id) REFERENCES visual_measuring_surveys (id)
);
...
(
    ...
    CONSTRAINT FK_CALCULATED_REPAIRS_ON_CALCULATED_PARTS_ELEMENTS
        FOREIGN KEY (element_id) REFERENCES calculated_parts_elements (id),
    CONSTRAINT FK_CALCULATED_REPAIRS_ON_VISUAL_MEASURING_SURVEYS
        FOREIGN KEY (visual_measuring_survey_id) REFERENCES visual_measuring_surveys (id)
);
