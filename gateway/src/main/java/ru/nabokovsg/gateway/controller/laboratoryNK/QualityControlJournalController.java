...
import ru.nabokovsg.gateway.client.laboratoryNK.QualityControlJournalClient;
...
@RestController
@RequestMapping(
        value = "/WorkVisionWeb/nk/journal/control",
        consumes = MediaType.ALL_VALUE,
        produces = MediaType.APPLICATION_JSON_VALUE)
@RequiredArgsConstructor
@Validated
@Tag(name="Журнал контроля качества",
        description="API для работы с данными журнала контроля качества")
public class QualityControlJournalController {

    private final QualityControlJournalClient client;

    @Operation(summary = "Добавление записи в журнал")
    @PostMapping
    public Mono<Object> save(@RequestBody @Valid @Parameter(description = "Информация об обследовании")
    ...
    @PatchMapping
    public Mono<Object> update(@RequestBody @Valid @Parameter(description = "Информация об обследовании")
