package ru.nabokovsg.gateway.dto.laboratoryNK.employeeCertificate;
...
@AllArgsConstructor
@NoArgsConstructor
@Schema(description = "Данные для добавления информации об аттестации сотрудника")
public class NewEmployeeCertificateDto {
