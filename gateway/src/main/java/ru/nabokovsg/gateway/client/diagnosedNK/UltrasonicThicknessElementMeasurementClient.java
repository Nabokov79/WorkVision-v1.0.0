...
@Service
public class UltrasonicThicknessElementMeasurementClient extends BaseClient {

    private static final String API_PREFIX = "/diagnosed/nk/measurement/ut";
    private static final String DELIMITER = "/";

    @Autowired
    public UltrasonicThicknessElementMeasurementClient(@Value("${diagnosedNK-server.url}") String baseUrl) {
